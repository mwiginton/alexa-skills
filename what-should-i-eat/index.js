...
// Questions
var nodes = [{ "node": 1, "message": "Do you like meat", "yes": 2, "no": 3 },
             { "node": 2, "message": "Do you like sea food", "yes": 4, "no": 5 },
             { "node": 3, "message": "Do you like noodles", "yes": 6, "no": 7 },
             { "node": 4, "message": "Do you like spicy food", "yes": 8, "no": 9 },
             { "node": 5, "message": "Do you like breakfast food", "yes": 10, "no": 11 },
             { "node": 6, "message": "Do you you want to be healthy today", "yes": 12, "no": 13 },
             { "node": 7, "message": "Do you like Asian food", "yes": 14, "no": 15 },

// Answers & descriptions
             { "node": 8,  "message": "Spicy Grilled Shrimp", "yes": 0, "no": 0, "description": "Delicious, garden fresh, and herb marinated spicy grilled shrimp." },
             { "node": 9,  "message": "Fried Catfish", "yes": 0, "no": 0, "description": "Crispy fried catfish fillets coated in a seasoned cornmeal crust with tartar sauce on the side."},
             { "node": 10, "message": "Pancakes with Bacon", "yes": 0, "no": 0 , "description": "A pancake is a flat cake, often thin, and round, prepared from a starch-based batter that may also contain eggs, milk and butter and cooked on a hot surface such as a griddle or frying pan, often with oil or butter. ."},
             { "node": 11, "message": "Hamburger", "yes": 0, "no": 0 , "description": "A hamburger is a sandwich consisting of one or more cooked patties of ground meat, usually beef, placed inside a sliced bread roll or bun."},
             { "node": 12, "message": "Picnic Pasta Salad", "yes": 0, "no": 0 , "description": "This quick and easy pasta salad features the fresh flavors of veggies and herbs.."},
             { "node": 13, "message": "Macaroni and Cheese", "yes": 0, "no": 0 , "description": "Macaroni noodles with cheddar cheese and tomato sauce."},
             { "node": 14, "message": "Veggie Stir Fry", "yes": 0, "no": 0 , "description": "Any of your favorite vegetables and sauces fried together in a pan. "},
             { "node": 15, "message": "Spring Rolls", "yes": 0, "no": 0 , "description": "Spring rolls with carrots, bean sprouts, green onions, and cabbage."},
];
